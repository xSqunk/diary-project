...
@section('content')
	...
	<div class="diary-container">
		<div class="diary-container-body">
			...
			<form action="{{ route( "$view_type.update" ) }}" id="form-user-insert" method="POST" novalidate enctype="multipart/form-data">
				@csrf

				<input type="hidden" name="userId" value="{{$user->hashId}}" />

				<div class="" style="display: flex;padding: 40px 0;">
					@include('dashboard.users.chunks.avatarContainer', ['avatar' => $user->meta->avatar])
